...
const CATEGORIES: Category[] = [
  {
    ...
    description: 'Help AI systems find and cite your content.',
    icon: '',
    tools: [
      { name: 'AI Visibility Scanner', tagline: 'Scan 14 signals and find out if AI can discover your business', price: '$399 one-time', href: '/scanner', badge: 'Flagship', screenshot: 'scanner' },
      { name: 'Structured Data Validator', tagline: 'Crawl any URL and validate JSON-LD schema — see your AI visibility score instantly', price: 'Pro', href: '/tools/schema-validator', screenshot: 'schema-validator', badge: 'New' },
      ...
      { name: 'robots.txt Generator', tagline: 'Control which AI crawlers can and cannot access your site', price: 'Free', href: '/tools/robots-generator', screenshot: 'robots-generator' },
    ],
  },
  {
    id: 'security',
    ...
    tools: [
      ...
      { name: 'SSL/TLS Inspector', tagline: 'Full TLS analysis — cert expiry, cipher grade, protocol version, security headers', price: 'Free', href: '/tools/ssl-inspector', screenshot: 'ssl-inspector', badge: 'New' },
      { name: 'Dependency CVE Scanner', tagline: 'Paste package.json or requirements.txt and get live CVEs from Google\'s OSV database', price: 'Pro', href: '/tools/dep-scanner', screenshot: 'dep-scanner', badge: 'New' },
      ...
      { name: 'Breach Lookup', tagline: 'Password breach check and domain security header audit', price: 'Free', href: '/tools/breach-lookup', screenshot: 'breach-lookup' },
      { name: 'Threat Intelligence Feed', tagline: 'Live malware URLs and botnet IPs from URLhaus and Feodo Tracker', price: 'Free', href: '/tools/threat-feed', screenshot: 'threat-feed' },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'JWT Decoder', tagline: 'Decode tokens — see header, payload, expiry, and all claims', price: 'Free', href: '/tools/jwt-decoder', screenshot: 'jwt-decoder' },
      ...
      { name: 'Cron Expression Builder', tagline: 'Build cron schedules visually or decode any expression', price: 'Free', href: '/tools/cron-builder', screenshot: 'cron-builder' },
  ...
  },
  {
    ...
    icon: '',
    tools: [
      { name: 'Invoice Generator', tagline: 'Create professional invoices and save as PDF — no account needed', price: 'Free', href: '/tools/invoice-generator', screenshot: 'invoice-generator' },
      ...
      { name: 'Business Name Availability', tagline: 'Check domains (.com .io .co .ai) and social handles — live results in seconds', price: 'Free', href: '/tools/business-name', screenshot: 'business-name', badge: 'New' },
      { name: 'SaaS Metrics Calculator', tagline: 'MRR, ARR, LTV, Churn, Quick Ratio, CAC Payback — all graded with industry benchmarks', price: 'Free', href: '/tools/saas-metrics', screenshot: 'saas-metrics', badge: 'New' },
      { name: 'Break-Even Calculator', tagline: 'Enter costs and price — know exactly how many units you need to sell to profit', price: 'Free', href: '/tools/break-even', screenshot: 'break-even', badge: 'New' },
      ...
      { name: 'NDA Generator', tagline: 'Generate mutual or one-way NDAs instantly — choose jurisdiction, term, and scope', price: 'Pro', href: '/tools/nda-generator', screenshot: 'nda-generator', badge: 'New' },
      { name: 'Terms of Service Generator', tagline: 'Generate a complete ToS for your SaaS or website — plain English, legally structured', price: 'Pro', href: '/tools/tos-generator', screenshot: 'tos-generator', badge: 'New' },
      ...
      { name: 'Ad Copy Grader', tagline: 'Score your ad headline and copy — get clarity, hook strength, CTA, and A/B test variants', price: 'Free', href: '/tools/ad-grader', screenshot: 'ad-grader', badge: 'New' },
      { name: 'Email Subject Line Tester', tagline: 'Score any subject line for open-rate potential, spam risk, and readability', price: 'Free', href: '/tools/subject-line', screenshot: 'subject-line', badge: 'New' },
      { name: 'Job Description Writer', tagline: 'Generate clear, bias-reduced job descriptions for any role — structured output, ready in seconds', price: 'Pro', href: '/tools/job-description', screenshot: 'job-description', badge: 'New' },
      { name: 'Proposal & Quote Generator', tagline: 'Generate a professional proposal — scope, deliverables, timeline, pricing', price: 'Pro', href: '/tools/proposal-generator', screenshot: 'proposal-generator', badge: 'New' },
