...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Job Description Writer', tagline: 'Generate clear, bias-reduced job descriptions for any role — AI-assisted, instantly', price: 'Pro', href: '/tools/job-description', screenshot: 'job-description', badge: 'New' },
