...
export default function NDAGeneratorPage() {
  ...
  const renderDocumentPreview = (text: string, endFraction: number, startFraction = 0) => {
    ...
    <div className="min-h-screen" style={{ background: '#070b14' }}>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="flex gap-3 flex-wrap mt-3 mb-4">
          <BuyToolButton toolId="nda-generator" price={29} className="inline-flex items-center gap-1 text-sm font-black px-4 py-2 rounded-xl text-black" style={{ background: 'linear-gradient(135deg,#6366f1,#4f46e5)' }} />
                    ...
                    <div className="relative mt-4">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center px-4">
                        <div className="w-full max-w-md">
                          <PaywallCard toolId="nda-generator" toolName="NDA Generator" oneTimePrice={29} freeLimit={1} accent="#a78bfa" />
                        </div>
                      </div>
        ...
        <div className="mt-14 rounded-2xl border p-6 text-center" style={{ background: 'rgba(99,102,241,0.05)', borderColor: 'rgba(99,102,241,0.15)' }}>
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            <BuyToolButton toolId="nda-generator" price={29} className="px-5 py-2.5 rounded-xl text-sm font-black text-black" style={{ background: 'linear-gradient(135deg,#6366f1,#4f46e5)' }} />
