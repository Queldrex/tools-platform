    ...
    <div className="min-h-screen" style={{ background: '#070b14' }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-white/40 text-sm mb-4">Calculate downtime from SLA percentages, model compound multi-service availability, and track your monthly error budget. License from $29, or get all 51 tools from $149.</p>
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/pricing" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-black border text-white/60" style={{ borderColor: 'rgba(255,255,255,0.12)' }}>All 51 tools — from $149 →</Link>
          </div>
        </div>
