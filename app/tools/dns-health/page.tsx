      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        {paywall && !loading && (
          <div className="rounded-2xl border p-8 text-center mb-6" style={{ background: 'rgba(52,211,153,0.05)', borderColor: 'rgba(52,211,153,0.2)' }}>
            ...
            <Link href="/monitor" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-black text-black" style={{ background: 'linear-gradient(135deg,#34d399,#059669)' }}>Start Pro â€” $79/month</Link>
          </div>
        )}

        {result && (
          <div className="space-y-3">
            <div className="rounded-2xl border p-5 flex flex-wrap gap-4" style={{ background: '#0d1117', borderColor: 'rgba(255,255,255,0.08)' }}>
              <div>
