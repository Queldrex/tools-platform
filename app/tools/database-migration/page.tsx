    ...
    <div className="min-h-screen" style={{ background: '#070b14' }}>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-5">
          ...
          <span className="text-sm font-bold text-white/30">Pro Tool · $199 or $29/month</span>
        </div>
        ...
        {checkCount >= 1 && (
          <div className="rounded-2xl border p-8 text-center mb-6" style={{ background: 'rgba(16,185,129,0.05)', borderColor: 'rgba(16,185,129,0.2)' }}>
            ...
            <p className="text-white/50 text-sm mb-6 max-w-sm mx-auto">Pro subscribers get unlimited migration checks, all tools, and monthly AI visibility monitoring — $29/month.</p>
