      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        {result && (
          <div className="space-y-4">
            <div className="rounded-2xl border p-6 flex items-center gap-6 flex-wrap" style={{ background: '#0d1117', borderColor: 'rgba(255,255,255,0.08)' }}>
...
export default function SSLInspectorPage() {
  return <Suspense fallback={null}><SSLInspectorContent /></Suspense>
}
