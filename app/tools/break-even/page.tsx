      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        {paywall && !loading && (
          <div className="rounded-2xl border p-8 text-center" style={{ background: 'rgba(167,139,250,0.05)', borderColor: 'rgba(167,139,250,0.2)' }}>
            ...
            <Link href="/monitor" className="inline-flex px-6 py-3 rounded-xl text-sm font-black text-black mt-4" style={{ background: 'linear-gradient(135deg,#06d6ff,#0891b2)' }}>Start Pro — $79/month</Link>
          </div>
        )}
