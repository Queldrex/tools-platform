  ...
  return (
    <div className="min-h-screen" style={{ background: '#070b14' }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-white/55 text-base mb-4 max-w-xl">Check domain availability and social handle availability for your business name — instantly, across all the extensions that matter.</p>
        ...
        {paywall && !loading && (
          <div className="rounded-2xl border p-8 text-center mb-6" style={{ background: 'rgba(74,222,128,0.05)', borderColor: 'rgba(74,222,128,0.2)' }}>
            ...
            <p className="text-white/50 text-sm mb-6 max-w-sm mx-auto">Pro plan: unlimited name checks, all tools, and monthly AI visibility monitoring. Cancel anytime.</p>
        ...
        <div className="mt-10 mb-8">
          ...
          <ul className="space-y-2 text-sm text-white/55">
            <li>• Founders checking domain and social handle availability before committing to a name</li>
            <li>• Indie hackers validating .com/.io/.ai availability in one shot</li>
            <li>• Agencies naming client projects and checking Twitter, GitHub, and LinkedIn handles</li>
            <li>• Product teams brainstorming brand names and instantly filtering by availability</li>
          </ul>
        </div>
        <div className="mt-14 rounded-2xl border p-6 text-center" style={{ background: 'rgba(6,214,255,0.04)', borderColor: 'rgba(6,214,255,0.12)' }}>
          <p className="text-white font-black mb-1">Add business name checking to your platform</p>
          <p className="text-white/40 text-sm mb-4">Domain availability (.com/.io/.co/.ai), Twitter/GitHub/LinkedIn handle check. One-time license.</p>
