        ...
        <div className="space-y-10 text-white/60 text-sm leading-relaxed">
          ...
          <section id="data-collected">
            ...
            <ul className="space-y-3 pl-4">
              ...
              <li>
                <strong className="text-white/80">Agency Plan ($199/month)</strong> — agency name, email address, client domain list, and scan history for up to 25 client domains per month. Retained while subscription is active and 12 months after cancellation.
              </li>
              <li>
