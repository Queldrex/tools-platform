...
const PROJECTS = [
  ...
  },
  {
    ...
    desc: 'A $99/month agency product where users manage AI visibility scanning for up to 25 client domains from a single dashboard. White-label PDF reports let agencies deliver branded results directly to their clients.',
    highlights: [
