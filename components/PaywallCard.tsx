...
export default function PaywallCard({ toolId, toolName, oneTimePrice, freeLimit, accent = '#06d6ff' }: PaywallCardProps) {
  ...
  return (
    <div className="rounded-2xl border p-8" style={{ background: 'rgba(6,214,255,0.03)', borderColor: 'rgba(6,214,255,0.15)' }}>
      ...
      <div className={`grid grid-cols-1 ${hasPurchaseOption ? 'sm:grid-cols-2' : ''} gap-4`}>
      ...
      <p className="text-center text-[11px] text-white/25 mt-4">Secure checkout via Stripe · No contracts · hello@queldrex.com for support</p>
