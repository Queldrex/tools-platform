...
export async function generateReportZip(scan: ScanResult): Promise<ArrayBuffer> {
  ...
  zip.file(
    'schema.json',
    `<!-- Paste this entire script tag inside the <head> of your website -->\n<script type="application/ld+json">\n${scan.generatedJsonLd}\n</script>`
  )
...
- report.html       Open in browser for your full visual report
- llms.txt          Upload to: ${scan.url}/llms.txt
- schema.json       Paste the script tag into your site <head>
- recommendations.md Prioritized action items
- README.txt        This file

Questions? support@queldrex.com`
  )
